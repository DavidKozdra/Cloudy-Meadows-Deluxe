...
// Core files needed for the game to start. Query strings (?v=7) are kept so the
...
const APP_SHELL = [
  ...
  './classes/Cloud.js',
  './classes/item.js?v=7',
  './classes/level.js?v=7',
  './classes/quest.js?v=7',
  './classes/dialouge.js?v=7',
  './classes/tile_classes/tile.js?v=7',
  './classes/tile_classes/plant.js?v=7',
  './classes/tile_classes/entity.js?v=7',
  './classes/tile_classes/moveable-entity.js?v=7',
  './classes/tile_classes/player.js?v=7',
  './classes/tile_classes/grid-move-entity.js?v=7',
  './classes/tile_classes/free-move-entity.js?v=7',
  './classes/tile_classes/light-move-entity.js?v=7',
  './classes/tile_classes/pay-to-move-entity.js?v=7',
  './classes/tile_classes/npc.js?v=7',
  './classes/tile_classes/shop.js?v=7',
  './classes/tile_classes/chest.js?v=7',
