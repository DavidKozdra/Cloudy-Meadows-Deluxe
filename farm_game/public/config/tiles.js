...
const TILE_DEFINITIONS = [
    ...
    /*102*/ { name: 'Ticket Master', png: 149, inv: [0], hand: 0, facing: 2, under_tile_num: 120, instructions: [], moving_timer: 120, class: 'NPC', places: ['Beach', 'The Big City', 'Cloudy Meadows'], travel_price: 10 },
    ...
    /*112*/ { name: 'Fisher Joe', png: 156, inv: [{num: 17, amount: 5}], hand: 0, facing: 2, under_tile_num: 120, instructions: [], moving_timer: 150, class: 'NPC', random_move: false },
    /*113*/ { name: 'Sandy', png: 157, inv: [{num: 11, amount: 5}], hand: 0, facing: 2, under_tile_num: 120, instructions: [], moving_timer: 100, class: 'NPC', random_move: false },
    /*114*/ { name: 'Skipper', png: 158, inv: [{num: 15, amount: 3}], hand: 0, facing: 2, under_tile_num: 120, instructions: [], moving_timer: 130, class: 'NPC', random_move: false },
