...
const TILE_DEFINITIONS = [
    ...
    /*115*/ { name: 'Priya Patel', png: 151, inv: [{num: 36, amount: 5}, {num: 37, amount: 3}], hand: 0, facing: 2, under_tile_num: 1, instructions: [], moving_timer: 100, class: 'NPC', quest_giver: true, random_move: false },
    /*116*/ { name: 'Marcus Brown', png: 152, inv: [{num: 35, amount: 15}, {num: 38, amount: 2}], hand: 0, facing: 2, under_tile_num: 1, instructions: [], moving_timer: 120, class: 'NPC', quest_giver: true, random_move: false },
    /*117*/ { name: 'Sophia Moore', png: 153, inv: [{num: 2, amount: 8}, {num: 35, amount: 6}], hand: 0, facing: 2, under_tile_num: 1, instructions: [], moving_timer: 100, class: 'NPC', quest_giver: true, random_move: false },
    /*118*/ { name: 'Jordan Kim', png: 154, inv: [{num: 13, amount: 4}, {num: 26, amount: 2}], hand: 0, facing: 2, under_tile_num: 1, instructions: [], moving_timer: 90, class: 'NPC', quest_giver: true, random_move: false },
    ...
    /*122*/ { name: 'Kiah', png: 162, inv: [0], hand: 0, facing: 2, under_tile_num: 1, instructions: [], moving_timer: 100, class: 'NPC', quest_giver: false, random_move: false },
    ...
    /*124*/ { name: 'HarvestBot', png: 45, under_tile_num: 1, instructions: ['down','harvest','up','harvest','right','harvest','left','harvest'], moving_timer: 80, class: 'FarmRobot' },
    /*125*/ { name: 'WaterBot', png: 46, under_tile_num: 1, instructions: ['right','water','right','water','right','water','left','left','left','water','water','water'], moving_timer: 100, class: 'FarmRobot' }
];
