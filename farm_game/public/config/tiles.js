...
const TILE_DEFINITIONS = [
    ...
    /*86*/  { name: 'Tool Shop', png: 126, inv: [
        ...
        {num: 50, amount: 1, price: 150} // Flashlight
    ...
    /*105*/ { name: 'Thomas', png: 165, inv: [{num: 35, amount: 20}], hand: 0, facing: 2, under_tile_num: 1, instructions: [], moving_timer: 100, class: 'Shop', quest_giver: true },
    /*106*/ { name: 'Victoria', png: 166, inv: [{num: 31, amount: 2}], hand: 0, facing: 2, under_tile_num: 1, instructions: [], moving_timer: 100, class: 'Shop', quest_giver: true },
    /*107*/ { name: 'Dante', png: 26, inv: [{num: 13, amount: 5}, {num: 2, amount: 10}], hand: 0, facing: 2, under_tile_num: 1, instructions: [], moving_timer: 100, class: 'Shop', quest_giver: true },
    /*108*/ { name: 'Kai', png: 26, inv: [{num: 35, amount: 5}], hand: 0, facing: 2, under_tile_num: 1, instructions: [], moving_timer: 100, class: 'Shop', quest_giver: true },
    /*109*/ { name: 'Job Board', png: 124, collide: true, age: -1, class: 'Tile' },
    /*110*/ { name: 'Coral', png: 155, inv: [{num: 7, amount: 10}], hand: 0, facing: 2, under_tile_num: 119, instructions: [], moving_timer: 120, class: 'NPC', random_move: false },
    /*111*/ { name: 'Fisher Joe', png: 156, inv: [{num: 17, amount: 5}], hand: 0, facing: 2, under_tile_num: 121, instructions: [], moving_timer: 150, class: 'NPC', random_move: false },
    /*112*/ { name: 'Sandy', png: 157, inv: [{num: 11, amount: 5}], hand: 0, facing: 2, under_tile_num: 121, instructions: [], moving_timer: 100, class: 'NPC', random_move: false },
    /*113*/ { name: 'Skipper', png: 158, inv: [{num: 15, amount: 3}], hand: 0, facing: 2, under_tile_num: 121, instructions: [], moving_timer: 130, class: 'NPC', random_move: false },
    /*114*/ { name: 'Alex Chen', png: 150, inv: [{num: 35, amount: 10}, {num: 31, amount: 2}], hand: 0, facing: 2, under_tile_num: 121, instructions: [], moving_timer: 100, class: 'NPC', quest_giver: false, random_move: false },
    /*115*/ { name: 'Priya Patel', png: 151, inv: [{num: 36, amount: 5}, {num: 37, amount: 3}], hand: 0, facing: 2, under_tile_num: 1, instructions: ['down', 'down', 'right', 'right', 'up', 'up', 'left', 'left'], moving_timer: 100, class: 'NPC', quest_giver: true, random_move: false },
    /*116*/ { name: 'Marcus Brown', png: 152, inv: [{num: 35, amount: 15}, {num: 38, amount: 2}], hand: 0, facing: 2, under_tile_num: 1, instructions: ['down', 'down', 'left', 'left', 'up', 'up', 'right', 'right'], moving_timer: 120, class: 'NPC', quest_giver: true, random_move: false },
    /*117*/ { name: 'Sophia Moore', png: 153, inv: [{num: 2, amount: 8}, {num: 35, amount: 6}], hand: 0, facing: 2, under_tile_num: 1, instructions: ['down', 'down', 'left', 'up', 'up', 'right'], moving_timer: 100, class: 'NPC', quest_giver: true, random_move: false },
    /*118*/ { name: 'Jordan Kim', png: 154, inv: [{num: 13, amount: 4}, {num: 26, amount: 2}], hand: 0, facing: 2, under_tile_num: 1, instructions: ['down', 'down', 'right', 'right', 'up', 'up', 'left', 'left'], moving_timer: 90, class: 'NPC', quest_giver: true, random_move: false },
    /*119*/ { name: 'sand', png: 159, collide: false, age: -1, class: 'Tile' },
    /*120*/ { name: 'water12', png: 160, collide: true, age: -1, class: 'Tile' },
    /*121*/ { name: 'towel', png: 161, collide: false, age: -1, class: 'Tile' },
    /*122*/ { name: 'Kiah', png: 162, inv: [0], hand: 0, facing: 2, under_tile_num: 1, instructions: ['up', 'up', 'right', 'down', 'down', 'left'], moving_timer: 100, class: 'NPC', quest_giver: false, random_move: false },
    /*123*/ { name: 'Scientist', png: 117, inv: [{num: 49, amount: 1}], hand: 0, facing: 2, under_tile_num: 1, instructions: [], moving_timer: 0, class: 'NPC', quest_giver: false, random_move: false },
    /*124*/ { name: 'HarvestBot', png: 45, under_tile_num: 1, instructions: ['down','harvest','up','harvest','right','harvest','left','harvest'], moving_timer: 30, class: 'FarmRobot' },
    /*125*/ { name: 'WaterBot', png: 46, under_tile_num: 1, instructions: ['right','water','right','water','right','water','left','left','left','water','water','water'], moving_timer: 30, class: 'FarmRobot' }
];
